...
public class CatchFailedDialogFragment extends BaseDialogFragment implements DialogInterface.OnKeyListener{

    private static final String TAG = "CatchFailed";
...
//    };
    ...
    private static CatchFailedDialogFragment instance;

    public static synchronized CatchFailedDialogFragment getInstance() {
         if (instance == null) {
             instance = new CatchFailedDialogFragment();
         }
     return instance;
    }
    ...
    public int setResLayoutId() {
        return R.layout.doll_catchfailed_dialog;
    }
